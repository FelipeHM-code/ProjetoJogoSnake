...
while True:
    ...
    ret_persona = pygame.draw.rect(tela, (255, 0, 0), (x_persona, y_persona, tamanho_bloco,tamanho_bloco))                                  #serve para criar um quadrado na tela, persona é quadrado, tela é variavel a cima
